...
#
#  def win
#    puts "The people cheer! You have defeated the dragon and bring it's scales home as a shield!"
#  end
#
#  def lose 
#    puts "You have died, the dragon has utterly destroyed you!"
#  end
#  
#  def tie
#    puts "Alright! You both died!!!! Where did you learn to fight?"
#  end
#  
#end
#
